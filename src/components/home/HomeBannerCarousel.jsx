...
const FALLBACK_BANNER = {
   ...
   description: 'Đặt món nhanh - Thanh toán tiện lợi - Nhận món bằng QR ngay tại trường.',
...
function HomeBannerCarousel({ banners = [] }) {
   ...
   const primaryImage = currentBanner.backgroundImage || FALLBACK_BANNER.backgroundImage;
   const fallbackImage = currentBanner.fallbackImage || FALLBACK_BANNER.backgroundImage;
   const imageSource = brokenSources[currentIndex] ? fallbackImage : primaryImage;
               ...
               <div className="flex gap-2">
                  {bannerItems.map((_, idx) => (
                     <button
                        ...
                        className={`h-2.5 rounded-full transition ${idx === currentIndex
                           ? 'w-8 bg-orange-500'
